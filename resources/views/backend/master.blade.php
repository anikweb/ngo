    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        ...
        @if (auth()->user()->can('general settings'))
            <li class="nav-item @if(Route::is('generalSetting.index')||Route::is('about-settings.index')||Route::is('terms.create')||Route::is('terms.edit')||Route::is('terms.index')||Route::is('privacy.create')||Route::is('privacy.edit')||Route::is('privacy.index')||Route::is('refund.create')||Route::is('refund.edit')||Route::is('refund.index')||Route::is('faq.create')||Route::is('faq.edit')||Route::is('faq.index')) menu-open @endif">
                <a href="#" class="nav-link @if(Route::is('generalSetting.index')||Route::is('about-settings.index')||Route::is('terms.create')||Route::is('terms.edit')||Route::is('terms.index')||Route::is('privacy.create')||Route::is('privacy.edit')||Route::is('privacy.index')||Route::is('refund.create')||Route::is('refund.edit')||Route::is('refund.index')||Route::is('faq.create')||Route::is('faq.edit')||Route::is('faq.index')) active @endif">
                ...
                <ul class="nav nav-treeview">
                    ...
                    @can('faq management')
                        <li class="nav-item">
                            <a href="{{ route('faq.index') }}" class="nav-link @if(Route::is('faq.create')||Route::is('faq.edit')||Route::is('faq.index')) active @endif">
                                <i class="far fa-circle nav-icon"></i>
                                <p>FAQ</p>
                            </a>
                        </li>
