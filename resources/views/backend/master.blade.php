    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        ...
        @if (auth()->user()->can('general settings'))
            <li class="nav-item @if(Route::is('generalSetting.index')||Route::is('about-settings.index')||Route::is('terms.create')||Route::is('terms.edit')||Route::is('terms.index')||Route::is('privacy.create')||Route::is('privacy.edit')||Route::is('privacy.index')) menu-open @endif">
