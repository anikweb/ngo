                                ...
                                <div class="col-md-6">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="{{ old('subtitle') }}" name="subtitle" id="subtitle" class="form-control @error('subtitle') is-invalid @enderror" placeholder="Enter subtitle">
                                                @error('subtitle')
                                                    <span class="text-danger"><i class="fa fa-exclamation-circle"></i> {{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="button_name" value="{{ old('button_name') }}" name="button_name" id="button_name" class="form-control @error('button_name') is-invalid @enderror" placeholder="Enter button name">
                                                    @error('button_name')
                                                        <span class="text-danger"><i class="fa fa-exclamation-circle"></i> {{ $message }}</span>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="button_link" value="{{ old('button_link') }}" name="button_link" id="button_link" class="form-control @error('button_link') is-invalid @enderror" placeholder="Enter button link">
                                                    @error('button_link')
                                                        <span class="text-danger"><i class="fa fa-exclamation-circle"></i> {{ $message }}</span>
                                                    @enderror
                                                </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <label for="left">
                                                <input @if(old('align') != 'center' || old('align') != 'right' ) checked @endif class="d-none" type="radio" name="align" id="left" value="left"><i class="fa fa-align-left p-2 left-icon" aria-hidden="true"></i>
                                            </label>
                                            <label for="center">
                                                <input @if(old('align') == 'center') checked @endif class="d-none"type="radio" name="align" id="center" value="center"><i class="fa fa-align-center p-2 center-icon" aria-hidden="true"></i>
                                            </label>
                                            <label for="right">
                                                <input class="d-none" @if(old('align') == 'right') checked @endif type="radio" name="align" id="right" value="right"><i class="fa fa-align-right p-2 right-icon" aria-hidden="true"></i>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12 text-center">
                                    <button class="btn btn-primary my-2"><i class="fa fa-plus"></i> Create Slider</button>
                                </div>
                            </div>
...
<script>
    ...
    $(document).ready(function() {
        @if(old('align') != 'center' && old('align') != 'right')
