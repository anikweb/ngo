    ...
    <div class="content">
        <div class="row">
            <div class="col-md-11 mx-auto my-1">
                <a href="{{ route('faq.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Add New</a>
            </div>
                                    ...
                                    @forelse ($faqs as $faq)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('faq.edit',$faq->id) }}" class="btn btn-primary"><i class="fa fa-edit"></i> Edit</a>
                                                <a href="javascript:void(0)" data-id="{{ $faq->id }}" class="btn btn-danger trash-btn"><i class="fa fa-trash"></i> Delete</a>
                                                <form id="trashForm-{{$faq->id}}" action="{{ route('faq.destroy',$faq->id) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
