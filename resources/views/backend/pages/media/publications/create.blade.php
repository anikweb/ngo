...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Create Publications</li>
        </ol>
    </nav>
    <div class="content">
        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="headline" value="{{ old('headline') }}" id="headline" class="form-control @error('headline') is-invalid @enderror" placeholder="Enter headline">
                                    @error('headline')
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('url') }}" name="url" id="url" class="form-control @error('url') is-invalid @enderror" placeholder="Enter url">
                                    @error('url')
                                        <div class="text-danger">
                                            <i class="fa fa-exclamation-circle"></i> {{ $message }}
                                        </div>
                            ...
                            <div class="col-md-6">
                                <label for="featured_image">Featured Image <span>*</span>
                                    <img src="{{ asset('images/placeholder/photo-placeholder.png') }}" id="image_preview" alt="placeholder image" class="img-fluid @error('featured_image')  border border-danger @enderror">
                                </label>
                            ...
                            <div class="col-md-12 text-center">
                                <button type="submit" class="btn btn-primary"><i class="fa fa-plus-circle"></i> Add Publications</button>
                            </div>
                        </div>
                    </form>
                   </div>
